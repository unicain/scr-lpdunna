        ...
        <div className="w-full max-w-2xl lg:shrink-0 xl:max-w-3xl">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <button
              ...
              className="rounded-full px-8 py-4 text-sm font-semibold text-white shadow-sm hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all transition-transform hover:scale-105"
            >
              {lpData.hero.ctaText}
            </button>
          </div>
